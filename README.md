...
实现歌曲播放，原文地址：[WeChat 背景音乐播放](https://www.jianshu.com/p/f3ba096ae611)

<img src="https://upload-images.jianshu.io/upload_images/1662958-86db25b5a0e421d2.gif?imageMogr2/auto-orient/strip" width="350">

项目分为**阅读**及**光影**模块，**阅读**部分通过文章进行了详细讲解，文章编写需要花费大量时间和精力，而之后想学习其他新知识，故**光影**部分未能通过文章进行讲解，但代码部分已经在**WeChat_end**中进行补全，相信有认真看过**阅读**部分文章的童鞋，能够理解该部分的代码逻辑，如有疑问可在Issues给我留言，需要注意的是，因为豆瓣对微信小程序的限制，**光影**中的接口数据是通过[Douban API Proxy](https://douban.uieee.com/)进行获取，如在后续不能正常访问，可自行联系